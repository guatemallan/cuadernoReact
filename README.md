...
No es un framework. Es una libreria de JavaScript para construir interfaces interactivas de forma sencilla. 

Tambien se encarga de la actualización y renderizado de los componentes de la aplicación de manera eficiente y sencilla, reaccionando a la interaccion del usuario. 

Se basa en componentes, definidos como funciones de JS que se utilizan para definir el diseño de la aplicación.
